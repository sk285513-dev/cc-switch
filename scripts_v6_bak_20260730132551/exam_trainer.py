...
class ExamTrainer:
    def __init__(self, db_path=None):
        ...
        self.embed_url = 'http://127.0.0.1:11434/api/embeddings'
    ...
    def run_all_exams(self, folder_path):
        ...
        for q_file in q_files:
            ...
            if a_file.exists():
                with open(q_file, 'r', encoding='utf-8-sig', errors='ignore') as f: q_text = f.read()
                with open(a_file, 'r', encoding='utf-8-sig', errors='ignore') as f: a_text = f.read()
