...
with open(r'C:\LocalAI_Workstation\old_engine_courses.json', 'r', encoding='utf-8-sig') as f:
...
# Save to whitelist
with open(r'C:\LocalAI_Workstation\whitelist_432.json', 'w', encoding='utf-8-sig') as f:
