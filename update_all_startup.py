...
with codecs.open(r"C:\LocalAI_Workstation\LexMind_Startup.ps1", "w", "utf-8-sig") as f:
    f.write(script_content)
    
vbs_content = '''Set WshShell = CreateObject("WScript.Shell")
WScript.Sleep 15000
WshShell.Run "powershell.exe -ExecutionPolicy Bypass -File ""C:\LocalAI_Workstation\LexMind_Startup.ps1""", 1, False
'''
with codecs.open(r"C:\Users\temp\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\三大監控視窗_AutoStart.vbs", "w", "utf-8-sig") as f:
    f.write(vbs_content)
