...
def dispatch_incident(incident_type, signature, source_file, message, count=1):
    incident = {
        ...
        while True:
            try:
                ...
                if idle_time > DEADLOCK_TIMEOUT_SECONDS:
                    ...
                    dispatch_incident("deadlock", "System Deadlock", "System", msg)
                    self.last_log_activity = datetime.now()
                ...
                if progress_idle_time > PROGRESS_TIMEOUT_SECONDS:
                    ...
                    dispatch_incident("zero_progress", "Zero Progress", "System", msg)
                    self.last_progress_activity = datetime.now()
            except Exception as e:
