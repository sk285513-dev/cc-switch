...
# Upstream: System Scheduler/Runner
# Downstream: System Processes
# Shared State: Process IDs, RAM Usage
...
WORKFLOW_SCRIPT = BASE_DIR / "scripts_v6" / "run_workflow.py"

# ==========================================
# [EXPERT FIX] 動態隔離資料夾與資料庫
# ==========================================
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(str(WATCHDOG_LOG), encoding="utf-8-sig"),
...
def reset_quota_state():
    ...
    try:
        ...
        qstate.write_text(json.dumps({"exhausted_keys": []}, ensure_ascii=False), encoding="utf-8-sig")
